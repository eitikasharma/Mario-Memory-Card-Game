...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>terms works!</p>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div id=\"wlcm\">\n<h1>BENVENUTO</h1>\n<br>\n<div id=\"instructions_div\">\n    <H2>HOW TO PLAY ?</H2>\n    <ol>\n        <li>Cards are mixed and set in a form of grid facing down.</li>\n        <li>Turn over any two cards.</li>\n        <li>If the two cards match, you score.</li>\n        <li>If they don't match, cards turns over.</li>\n        <li>Remember what was on each card and where it was.</li>\n        <li>The game is completed when all the cards have been matched.</li>\n    </ol>   \n    <h3>Good Luck!!!!!</h3>\n\n    <button routerLink = \"/game\">Play</button> \n</div>    \n</div>\n");
...
/* harmony import */ var _card_grid_card_grid_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./card-grid/card-grid.component */ "./src/app/card-grid/card-grid.component.ts");
/* harmony import */ var _instruction_instruction_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./instruction/instruction.component */ "./src/app/instruction/instruction.component.ts");
...
/* harmony import */ var _user_registration_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./user-registration.service */ "./src/app/user-registration.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _instruction_instruction_component__WEBPACK_IMPORTED_MODULE_9__["InstructionComponent"],
            _card_grid_card_grid_component__WEBPACK_IMPORTED_MODULE_8__["CardGridComponent"],
        ...
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forRoot([
                ...
                { path: '', component: _registeration_registeration_component__WEBPACK_IMPORTED_MODULE_10__["RegisterationComponent"] },
                { path: 'welcome', component: _welcome_welcome_component__WEBPACK_IMPORTED_MODULE_13__["WelcomeComponent"] },
                { path: 'submit', component: _terms_terms_component__WEBPACK_IMPORTED_MODULE_11__["TermsComponent"] },
                { path: 'game', component: _card_grid_card_grid_component__WEBPACK_IMPORTED_MODULE_8__["CardGridComponent"] }
            ])
        ],
...
let CardGridComponent = class CardGridComponent {
    ...
    startGame(l) {
        ...
        for (var i = 0; i < this.gameGrid.length; i++) {
            ...
            var name = this.gameGrid[i].name, img = this.gameGrid[i].img;
...
CardGridComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-card-grid',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./card-grid.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/card-grid/card-grid.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./card-grid.component.css */ "./src/app/card-grid/card-grid.component.css")).default]
    })
], CardGridComponent);
...
InstructionComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./instruction.component.css */ "./src/app/instruction/instruction.component.css")).default]
    })
...
], RegisterationComponent.prototype, "name", void 0);
RegisterationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-registeration',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./registeration.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/registeration/registeration.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./registeration.component.css */ "./src/app/registeration/registeration.component.css")).default]
    })
...
let UserRegistrationService = class UserRegistrationService {
    ...
    doRegistration(user) {
        return this.http.post("http://localhost:8090/create", user, { responseType: 'text' });
    }
    gettingCredentials() {
...
module.exports = __webpack_require__(/*! C:\Users\DELL\Desktop\Project\src\main.ts */"./src/main.ts");
